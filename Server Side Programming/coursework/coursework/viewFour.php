      ...
      <div class="country-display">
         <table align="center" class="country-display">
            ...
            <script type="text/javascript">
               ...
               $("#comparison").append("<h3>"+obj[field].country_name + " had a total of "+ obj[field].total +" medals whereas " + obj1[field].country_name  + " had a total of "+ obj1[field].total +" medals, a difference of "+ differenceCalculation(obj1[field].total, obj[field].total)+"</h3>");
               $("#comparison").append("<h3>"+highestGDP(obj[field].gdp,obj1[field].gdp,obj2[field].gdp,obj3[field].gdp) + " Was the highest GDP of the countries selected</h3>");
               $("#comparison").append("<h3>"+highestGDP(obj[field].population,obj1[field].population,obj2[field].population,obj3[field].population) + " was the highest population of countries compared</h3>");
			   }
