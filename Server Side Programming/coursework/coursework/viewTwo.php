      ...
      <div class="country-display">
         <table align="center" class="country-display">
            <?php
               ...
               echo '<tr>';
               echo '<th><h4 class="medalsHeading">Country</h4></th>';
               echo '<th><h4 class="medalsHeading">Gold</h4></th>';
               echo '<th><h4 class="medalsHeading">Silver</h4></th>';
               echo '<th><h4 class="medalsHeading">Bronze</h4></th>';
               echo '<th><h4 class="medalsHeading">Total</h4></th>';
               echo '<th><h4 class="medalsHeading">G.D.P</h4></th>';
               echo '<th><h4 class="medalsHeading">Population</h4></th>';
               echo '</tr>';
